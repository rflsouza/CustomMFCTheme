...
protected:  // control bar embedded members
	...
	CDialogTeste cDialogTesteOutlookbar;
...
protected:
	...
	afx_msg void OnBtnRibbonCategoryGradStart();
	afx_msg void OnBtnRibbonCategoryGradEnd();
	afx_msg void OnBtnRibbonPanelCaptionBk();
	afx_msg void OnBtnRibbonPanelGradStart();
	afx_msg void OnBtnRibbonPanelGradEnd();
	afx_msg void OnBtnRibbonPanelCaptionText();
	afx_msg void OnBtnRibbonPanelCaptopnTextHilite();
	afx_msg void OnBtnRibbonPanelButtonText();
	afx_msg void OnBtnRibbonBarBackground();
	afx_msg void OnBtnRibbonPanelOutline();
	afx_msg void OnBtnRibbonBarText();
	afx_msg void OnBtnRibbonBarTextHilite();
	afx_msg void OnBtnRibbonBarGetCode();

	CMFCVisualManager* IsDeviantVisualManager();

	CString ConvertToTextRGB(COLORREF clr);
