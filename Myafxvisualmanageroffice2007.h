...
class MyCMFCVisualManagerOffice2007 : public CMFCVisualManagerOffice2003
{
	DECLARE_DYNCREATE(MyCMFCVisualManagerOffice2007)

protected:
	MyCMFCVisualManagerOffice2007();
	virtual ~MyCMFCVisualManagerOffice2007();
...
public:
	...
	BOOL MyReadColor(const CString& strValue, COLORREF& value)
	{
		value = RGB(255, 0, 0);
		return TRUE;
	};
